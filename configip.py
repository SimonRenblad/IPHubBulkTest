INPUT_FILE = "ipaddresses.txt" # name of list of ip addresses (should not be longer than 800-900 addresses)

GOOD_OUTPUT_FILE = "goodips.txt" # intended name of good addresses
